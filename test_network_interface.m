function test_network_interface(net)
    ...
    selectImageButton = uicontrol('Style', 'pushbutton', 'String', 'Select Image', 'Position', [200, 30, 150, 40], 'Callback', @selectImageCallback, 'FontSize', 12, 'BackgroundColor', [0.2, 0.5, 0.8], 'ForegroundColor', [1, 1, 1]);

    % Create the button for capturing an image from the camera
    captureImageButton = uicontrol('Style', 'pushbutton', 'String', 'Capture Image', 'Position', [450, 30, 150, 40], 'Callback', @captureImageCallback, 'FontSize', 12, 'BackgroundColor', [0.8, 0.2, 0.2], 'ForegroundColor', [1, 1, 1]);
